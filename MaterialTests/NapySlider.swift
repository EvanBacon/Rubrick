...
//            let position = Int((positionFromMin * step + min + stepOffset) / step) * Int(step)
    ...
    public override func layoutSubviews() {
        ...
        currentPosLabel.frame = CGRectMake(-(handleView.frame.width + handleWidth), handleView.frame.origin.y + handleHeight*0.5/2, handleWidth, handleHeight * 1.5)
    ...
    private func moveHandleToPoint(point:CGPoint) {
        ...
        currentPosLabel.frame = CGRectMake(-(handleView.frame.width + currentPosLabel.frame.width), handleView.frame.origin.y + handleHeight*0.5/2, currentPosLabel.frame.width, currentPosLabel.frame.height)
...
class TriangleView : UIView {
    ...
    override func drawRect(rect: CGRect) {
        ...
        CGContextMoveToPoint(ctx, CGRectGetMaxX(rect), CGRectGetMaxY(rect)/2.0)
